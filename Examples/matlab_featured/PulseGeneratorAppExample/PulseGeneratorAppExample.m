...
% This app shows how to generate a pulse from instrumentation controls. It uses the 
% following components to gather user input and plot the resulting wave form:
% 
% * Numeric edit fields &mdash; allow users to enter the pulse frequency and length. 
% MATLAB&reg; automatically checks to make sure the values are numeric and within 
% the range specified by the app.
